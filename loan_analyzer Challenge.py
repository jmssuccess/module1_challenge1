...
total_of_all_loans = sum(loan_cost)
print(f"The Total value is {total_of_all_loans}")
...
if present_value > loan_price:
    print("This loan is worth a look")
...
def calculate_present_value(present_value):
    present_value = future_value / (1 + Discount_Rate/12)**remaining_months
...
new_loan_present_value = calculate_present_value(present_value)
print(new_loan_present_value)
